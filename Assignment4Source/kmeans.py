...
def main():
    ...
    file1 = '/Users/divya/Documents/Machine Learning/Assignments/Assignment4Source/optdigits/optdigits.train'
    testFile = '/Users/divya/Documents/Machine Learning/Assignments/Assignment4Source/optdigits/optdigits.test'
    ...
    print(" Sum square sep:", sumSquaredSeparation(testCenters))
    print("Entropy: ",meanEntropy(testClusters,NUM_CENTERS, column))
    print(" Sum squared Error:",sumSquaredError(testCenters,testClusters))
...
def writeMe(Llists):
    ...
    with open('/Users/divya/Documents/Machine Learning/Assignments/Assignment4Source/optdigits/kMeans.pgm','w' ) as f:
