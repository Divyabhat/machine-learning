...
training_data = './trainingdata/mnist_train.csv'
testing_data = './trainingdata/mnist_validation.csv'
...
for each in range(50):
    trn_accuracy = perceptron.perceptron_learn(epoch=each, input_ds=perceptron.train_data, set_flag=1)
    print("Training Accuracy = ", trn_accuracy)
